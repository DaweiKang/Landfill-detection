...
def get_params():
    params = {
        'weight': 'C:/Users\kang_\PycharmProjects\pythonProject2/ultralytics-main\yolov8n.pt',  # 训练出来的权重文件
        'cfg': r'C:\Users\kang_\PycharmProjects\pythonProject2\ultralytics-main\ultralytics\cfg\models\v8\yolov8.yaml',  # 训练权重对应的yaml配置文件
        'device': 'cuda:0',
...
if __name__ == '__main__':
    ...
    model(r'C:\Users\kang_\PycharmProjects\pythonProject2\ultralytics-main\data\mycoco\images\train\NI8790_jpg.rf.6ffcca13d5932ceb4db510744abedb6e.jpg', r'C:\Users\kang_\PycharmProjects\pythonProject2\ultralytics-main\result')  # 第一个是检测的文件, 第二个是保存的路径